				...
				<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image img-responsive" src="{{url("public",$produk->foto)}}" alt="" >
									<img class="etalage_source_image img-responsive" src="{{url("public",$produk->foto)}}" alt="" >
								</a>
							</li>
